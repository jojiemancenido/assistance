...
if ($format === "excel") {
  ...
  header("Content-Disposition: attachment; filename=\"assistance_records_" . $stamp . ".xls\"");
...
header("Content-Disposition: attachment; filename=\"assistance_records_" . $stamp . ".pdf\"");
